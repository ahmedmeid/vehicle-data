...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ahmedmeid.fleet.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ahmedmeid.fleet.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
